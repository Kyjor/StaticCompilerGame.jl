...
pass:                                             ; preds = %top
  %5 = icmp eq {}* %on_ground, inttoptr (i64 140506237382000 to {}*)
  %common.ret.op = select i1 %5, i32 2, i32 3
