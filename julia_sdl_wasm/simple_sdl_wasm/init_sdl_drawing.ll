...
define internal fastcc void @println_1035({}* noundef nonnull %0) unnamed_addr {
top:
...
define i32 @init_sdl_drawing() local_unnamed_addr {
top:
  ...
  call fastcc void @println_1035({}* inttoptr (i64 140506323632200 to {}*))
  ret i32 0
}
