...
define internal fastcc void @println_1730({}* noundef nonnull %0) unnamed_addr {
top:
...
define void @present_frame() local_unnamed_addr {
top:
  %0 = alloca {}*, align 8
  %gcframe = call {}** @julia.new_gc_frame(i32 1)
  call void @julia.push_gc_frame({}** nonnull %gcframe, i32 1)
...
L6:                                               ; preds = %pass
  call fastcc void @println_1730({}* inttoptr (i64 140506323633152 to {}*))
  br label %common.ret
