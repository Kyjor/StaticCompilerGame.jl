...
define internal fastcc void @println_1905({}* noundef nonnull %0) unnamed_addr {
top:
...
define internal fastcc void @julia_clear_screen_1910(i32 signext %0) unnamed_addr {
top:
  %1 = alloca [2 x {}*], align 8
  %.sub = getelementptr inbounds [2 x {}*], [2 x {}*]* %1, i64 0, i64 0
  %gcframe = call {}** @julia.new_gc_frame(i32 1)
...
pass8:                                            ; preds = %idxend
  ...
  store {}* %22, {}** %23, align 8
  call fastcc void @println_1905({}* %22)
  br label %common.ret
}
...
define internal fastcc void @julia_draw_rect_1907(i32 signext %0, i32 signext %1, i32 signext %2, i32 signext %3, i32 signext %4) unnamed_addr {
top:
...
pass8:                                            ; preds = %idxend
  ...
  store {}* %42, {}** %43, align 8
  call fastcc void @println_1905({}* %42)
  br label %common.ret
}

declare nonnull {}* @ijl_box_int32(i32 signext) local_unnamed_addr

define internal fastcc void @julia_present_frame_1902() unnamed_addr {
top:
  %0 = alloca {}*, align 8
  %gcframe = call {}** @julia.new_gc_frame(i32 1)
  call void @julia.push_gc_frame({}** nonnull %gcframe, i32 1)
...
L6:                                               ; preds = %pass
  call fastcc void @println_1905({}* inttoptr (i64 140506323633152 to {}*))
  br label %common.ret
...
L6:                                               ; preds = %pass
  call fastcc void @julia_clear_screen_1910(i32 signext 0)
...
L20:                                              ; preds = %L15
  ...
  call fastcc void @julia_draw_rect_1907(i32 signext %unbox, i32 signext %unbox9, i32 signext 32, i32 signext 32, i32 signext 3)
  br label %L39
...
L32:                                              ; preds = %L27
  ...
  call fastcc void @julia_draw_rect_1907(i32 signext %unbox14, i32 signext %unbox15, i32 signext 32, i32 signext 32, i32 signext 2)
  br label %L39
...
L39:                                              ; preds = %L36, %L32, %L24, %L20
  call fastcc void @julia_present_frame_1902()
  br label %common.ret
