...
define double @get_new_vel_y() local_unnamed_addr {
top:
...
L5:                                               ; preds = %top
  ...
  store {}* %square_vel_y, {}** %6, align 8
  store {}* inttoptr (i64 140506169424384 to {}*), {}** %.sub, align 8
  %7 = getelementptr inbounds [2 x {}*], [2 x {}*]* %0, i64 0, i64 1
  store {}* %square_vel_y, {}** %7, align 8
  ...
  %exactly_isa2 = icmp eq {}* %13, inttoptr (i64 140506169424384 to {}*)
  br i1 %exactly_isa2, label %L8, label %fail

L8:                                               ; preds = %L5, %top
  %value_phi = phi {}* [ %square_vel_y, %top ], [ %8, %L5 ]
  %14 = bitcast {}* %value_phi to double*
  %unbox = load double, double* %14, align 8, !tbaa !18, !alias.scope !7, !noalias !10
  call void @julia.pop_gc_frame({}** nonnull %gcframe)
  ret double %unbox

fail:                                             ; preds = %L5
  call void @ijl_type_error(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @_j_str1, i64 0, i64 0), {}* inttoptr (i64 140506169424384 to {}*), {}* %8)
  unreachable
}
