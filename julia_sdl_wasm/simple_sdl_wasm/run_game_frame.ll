...
define internal fastcc void @println_1963({}* noundef nonnull %0) unnamed_addr {
top:
...
define internal fastcc void @julia_clear_screen_1968(i32 signext %0) unnamed_addr {
top:
  %1 = alloca [2 x {}*], align 8
  %.sub = getelementptr inbounds [2 x {}*], [2 x {}*]* %1, i64 0, i64 0
  %gcframe = call {}** @julia.new_gc_frame(i32 1)
...
pass8:                                            ; preds = %idxend
  ...
  store {}* %22, {}** %23, align 8
  call fastcc void @println_1963({}* %22)
  br label %common.ret
}
...
define internal fastcc void @julia_draw_rect_1965(i32 signext %0, i32 signext %1, i32 signext %2, i32 signext %3, i32 signext %4) unnamed_addr {
top:
...
pass8:                                            ; preds = %idxend
  ...
  store {}* %42, {}** %43, align 8
  call fastcc void @println_1963({}* %42)
  br label %common.ret
}

declare nonnull {}* @ijl_box_int32(i32 signext) local_unnamed_addr

define internal fastcc void @julia_present_frame_1960() unnamed_addr {
top:
  %0 = alloca {}*, align 8
  %gcframe = call {}** @julia.new_gc_frame(i32 1)
  call void @julia.push_gc_frame({}** nonnull %gcframe, i32 1)
...
L6:                                               ; preds = %pass
  call fastcc void @println_1963({}* inttoptr (i64 140506323633152 to {}*))
  br label %common.ret
...
define internal fastcc void @julia_draw_frame_1955() unnamed_addr {
top:
  ...
  store {}* %drawing_enabled, {}** %1, align 8
  store {}* %drawing_enabled, {}** %.sub, align 8
  %2 = call nonnull {}* @ijl_apply_generic({}* inttoptr (i64 140506102030896 to {}*), {}** nonnull %.sub, i32 1)
  %3 = bitcast {}* %2 to i64*
  %4 = getelementptr inbounds i64, i64* %3, i64 -1
  %5 = load atomic i64, i64* %4 unordered, align 8, !tbaa !15, !range !17
  %6 = and i64 %5, -16
...
common.ret:                                       ; preds = %pass, %L39
  call void @julia.pop_gc_frame({}** nonnull %gcframe)
  ret void

L6:                                               ; preds = %pass
  call fastcc void @julia_clear_screen_1968(i32 signext 0)
  ...
  store {}* %square_x, {}** %8, align 8
  store {}* %square_x, {}** %.sub, align 8
  %9 = call nonnull {}* @ijl_apply_generic({}* inttoptr (i64 140506112681664 to {}*), {}** nonnull %.sub, i32 1)
  %10 = call {}** @julia.get_gc_frame_slot({}** nonnull %gcframe, i32 0)
  store {}* %9, {}** %10, align 8
  store {}* %9, {}** %.sub, align 8
  %11 = call nonnull {}* @ijl_apply_generic({}* inttoptr (i64 140506169425248 to {}*), {}** nonnull %.sub, i32 1)
  %square_y = load atomic {}*, {}** inttoptr (i64 140506294853184 to {}**) unordered, align 64, !tbaa !2, !alias.scope !7, !noalias !10
  %12 = call {}** @julia.get_gc_frame_slot({}** nonnull %gcframe, i32 1)
  store {}* %square_y, {}** %12, align 8
  %13 = call {}** @julia.get_gc_frame_slot({}** nonnull %gcframe, i32 0)
  store {}* %11, {}** %13, align 8
  store {}* %square_y, {}** %.sub, align 8
  %14 = call nonnull {}* @ijl_apply_generic({}* inttoptr (i64 140506112681664 to {}*), {}** nonnull %.sub, i32 1)
  %15 = call {}** @julia.get_gc_frame_slot({}** nonnull %gcframe, i32 1)
  store {}* %14, {}** %15, align 8
  store {}* %14, {}** %.sub, align 8
  %16 = call nonnull {}* @ijl_apply_generic({}* inttoptr (i64 140506169425248 to {}*), {}** nonnull %.sub, i32 1)
  %on_ground = load atomic {}*, {}** inttoptr (i64 140506294853952 to {}**) unordered, align 64, !tbaa !2, !alias.scope !7, !noalias !10
  %17 = bitcast {}* %on_ground to i64*
  %18 = getelementptr inbounds i64, i64* %17, i64 -1
  %19 = load atomic i64, i64* %18 unordered, align 8, !tbaa !15, !range !17
  %20 = and i64 %19, -16
  %21 = inttoptr i64 %20 to {}*
  %exactly_isa2 = icmp eq {}* %21, inttoptr (i64 192 to {}*)
  br i1 %exactly_isa2, label %pass4, label %fail3

L15:                                              ; preds = %pass4
  br i1 %50, label %L24, label %L20

L20:                                              ; preds = %L15
  %22 = bitcast {}* %11 to i32*
  %unbox = load i32, i32* %22, align 4, !tbaa !29, !alias.scope !7, !noalias !10
  %23 = bitcast {}* %16 to i32*
  %unbox9 = load i32, i32* %23, align 4, !tbaa !29, !alias.scope !7, !noalias !10
  call fastcc void @julia_draw_rect_1965(i32 signext %unbox, i32 signext %unbox9, i32 signext 32, i32 signext 32, i32 signext 3)
  br label %L39
...
L24:                                              ; preds = %L15
  ...
  %25 = getelementptr inbounds [5 x {}*], [5 x {}*]* %0, i64 0, i64 1
  store {}* %16, {}** %25, align 8
  %26 = getelementptr inbounds [5 x {}*], [5 x {}*]* %0, i64 0, i64 2
  store {}* inttoptr (i64 140506325738512 to {}*), {}** %26, align 8
  %27 = getelementptr inbounds [5 x {}*], [5 x {}*]* %0, i64 0, i64 3
  store {}* inttoptr (i64 140506325738512 to {}*), {}** %27, align 8
  %28 = getelementptr inbounds [5 x {}*], [5 x {}*]* %0, i64 0, i64 4
  store {}* inttoptr (i64 140506325730160 to {}*), {}** %28, align 8
  %29 = call nonnull {}* @ijl_apply_generic({}* inttoptr (i64 140504356875944 to {}*), {}** nonnull %.sub, i32 5)
  br label %L39

L27:                                              ; preds = %pass4
  br i1 %50, label %L36, label %L32

L32:                                              ; preds = %L27
  %30 = bitcast {}* %11 to i32*
  %unbox14 = load i32, i32* %30, align 4, !tbaa !29, !alias.scope !7, !noalias !10
  %31 = bitcast {}* %16 to i32*
  %unbox15 = load i32, i32* %31, align 4, !tbaa !29, !alias.scope !7, !noalias !10
  call fastcc void @julia_draw_rect_1965(i32 signext %unbox14, i32 signext %unbox15, i32 signext 32, i32 signext 32, i32 signext 2)
  br label %L39

L36:                                              ; preds = %L27
  %32 = call {}** @julia.get_gc_frame_slot({}** nonnull %gcframe, i32 1)
  store {}* %16, {}** %32, align 8
  store {}* %11, {}** %.sub, align 8
  %33 = getelementptr inbounds [5 x {}*], [5 x {}*]* %0, i64 0, i64 1
  store {}* %16, {}** %33, align 8
  %34 = getelementptr inbounds [5 x {}*], [5 x {}*]* %0, i64 0, i64 2
  store {}* inttoptr (i64 140506325738512 to {}*), {}** %34, align 8
  %35 = getelementptr inbounds [5 x {}*], [5 x {}*]* %0, i64 0, i64 3
  store {}* inttoptr (i64 140506325738512 to {}*), {}** %35, align 8
  %36 = getelementptr inbounds [5 x {}*], [5 x {}*]* %0, i64 0, i64 4
  store {}* inttoptr (i64 140506325729872 to {}*), {}** %36, align 8
  %37 = call nonnull {}* @ijl_apply_generic({}* inttoptr (i64 140504356875944 to {}*), {}** nonnull %.sub, i32 5)
  br label %L39

L39:                                              ; preds = %L36, %L32, %L24, %L20
  call fastcc void @julia_present_frame_1960()
  br label %common.ret
...
pass:                                             ; preds = %top
  %38 = icmp eq {}* %2, inttoptr (i64 140506237382000 to {}*)
  br i1 %38, label %L6, label %common.ret

fail3:                                            ; preds = %L6
  call void @ijl_type_error(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @_j_str1, i64 0, i64 0), {}* inttoptr (i64 140506169425120 to {}*), {}* %on_ground)
  unreachable

pass4:                                            ; preds = %L6
  %39 = icmp eq {}* %on_ground, inttoptr (i64 140506237382000 to {}*)
  %40 = bitcast {}* %11 to i64*
  %41 = getelementptr inbounds i64, i64* %40, i64 -1
  %42 = load atomic i64, i64* %41 unordered, align 8, !tbaa !15, !range !17
  %43 = and i64 %42, -16
  %44 = inttoptr i64 %43 to {}*
  %exactly_isa11 = icmp ne {}* %44, inttoptr (i64 240 to {}*)
  %45 = bitcast {}* %16 to i64*
  %46 = getelementptr inbounds i64, i64* %45, i64 -1
  %47 = load atomic i64, i64* %46 unordered, align 8, !tbaa !15, !range !17
  %48 = and i64 %47, -16
  %49 = inttoptr i64 %48 to {}*
  %exactly_isa13 = icmp ne {}* %49, inttoptr (i64 240 to {}*)
  %50 = or i1 %exactly_isa11, %exactly_isa13
  br i1 %39, label %L27, label %L15
}

define internal fastcc void @julia_handle_events_1953() unnamed_addr {
top:
  %0 = alloca {}*, align 8
  %gcframe = call {}** @julia.new_gc_frame(i32 1)
  call void @julia.push_gc_frame({}** nonnull %gcframe, i32 1)
...
top:
  call fastcc void @julia_update_physics_1971()
  call fastcc void @julia_draw_frame_1955()
  call fastcc void @julia_handle_events_1953()
  ret i32 0
}

define internal fastcc void @julia_update_physics_1971() unnamed_addr {
top:
