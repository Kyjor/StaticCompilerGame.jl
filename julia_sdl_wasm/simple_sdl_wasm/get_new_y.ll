...
define i32 @get_new_y() local_unnamed_addr {
top:
  %0 = call fastcc i32 @julia_get_square_y_2194()
  ret i32 %0
}

define internal fastcc i32 @julia_get_square_y_2194() unnamed_addr {
top:
  ...
  store {}* %square_y, {}** %1, align 8
  store {}* %square_y, {}** %.sub, align 8
  %2 = call nonnull {}* @ijl_apply_generic({}* inttoptr (i64 140506112681664 to {}*), {}** nonnull %.sub, i32 1)
  %3 = call {}** @julia.get_gc_frame_slot({}** nonnull %gcframe, i32 0)
  store {}* %2, {}** %3, align 8
  store {}* %2, {}** %.sub, align 8
  %4 = call nonnull {}* @ijl_apply_generic({}* inttoptr (i64 140506169425248 to {}*), {}** nonnull %.sub, i32 1)
  %5 = bitcast {}* %4 to i64*
...
L7:                                               ; preds = %top
  ...
  store {}* %4, {}** %10, align 8
  store {}* inttoptr (i64 140506169425248 to {}*), {}** %.sub, align 8
  %11 = getelementptr inbounds [2 x {}*], [2 x {}*]* %0, i64 0, i64 1
  store {}* %4, {}** %11, align 8
  %12 = call nonnull {}* @ijl_apply_generic({}* inttoptr (i64 140506098541952 to {}*), {}** nonnull %.sub, i32 2)
...
fail:                                             ; preds = %L7
  call void @ijl_type_error(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @_j_str1, i64 0, i64 0), {}* inttoptr (i64 140506169425248 to {}*), {}* %12)
  unreachable
}
