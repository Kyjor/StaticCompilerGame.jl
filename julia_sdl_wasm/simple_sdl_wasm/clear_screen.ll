...
define internal fastcc void @println_1589({}* noundef nonnull %0) unnamed_addr {
top:
...
define void @clear_screen(i32 signext %0) local_unnamed_addr {
top:
  %1 = alloca [2 x {}*], align 8
  %.sub = getelementptr inbounds [2 x {}*], [2 x {}*]* %1, i64 0, i64 0
  %gcframe = call {}** @julia.new_gc_frame(i32 1)
...
pass8:                                            ; preds = %idxend
  ...
  store {}* %22, {}** %23, align 8
  call fastcc void @println_1589({}* %22)
  br label %common.ret
}
