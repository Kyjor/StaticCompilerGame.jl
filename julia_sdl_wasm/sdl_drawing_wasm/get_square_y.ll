...
L7:                                               ; preds = %top
  ...
  store {}* %4, {}** %10, align 8
  store {}* inttoptr (i64 140467114163552 to {}*), {}** %.sub, align 8
  %11 = getelementptr inbounds [2 x {}*], [2 x {}*]* %0, i64 0, i64 1
  store {}* %4, {}** %11, align 8
  %12 = call nonnull {}* @ijl_apply_generic({}* inttoptr (i64 140467043280256 to {}*), {}** nonnull %.sub, i32 2)
...
fail:                                             ; preds = %L7
  call void @ijl_type_error(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @_j_str1, i64 0, i64 0), {}* inttoptr (i64 140467114163552 to {}*), {}* %12)
  unreachable
}
