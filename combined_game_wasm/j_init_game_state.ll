...
top:
  ...
  call fastcc void @julia_j_init_game_state_1688u1691()
  ...
  %status.i32 = call i32 (i8*, ...) @printf(i8* noundef nonnull %.sub51, i32 1, i32 320) #0
  ...
  %status.i34 = call i32 (i8*, ...) @printf(i8* noundef nonnull %.sub52, i32 1, i32 320) #0
  call void @llvm.lifetime.end.p0i8(i64 62, i8* nonnull %.sub52)
  call fastcc void @julia_j_init_game_state_1688u1694(i32 1, i32 320)
  ...
  %status.i36 = call i32 (i8*, ...) @printf(i8* noundef nonnull %.sub53, i32 2, i32 448) #0
  ...
  %status.i38 = call i32 (i8*, ...) @printf(i8* noundef nonnull %.sub54, i32 2, i32 448) #0
  call void @llvm.lifetime.end.p0i8(i64 62, i8* nonnull %.sub54)
  call fastcc void @julia_j_init_game_state_1688u1694(i32 2, i32 448)
  ...
  call fastcc void @julia_j_init_game_state_1688u1694(i32 3, i32 0)
  ...
  call fastcc void @julia_j_init_game_state_1688u1694(i32 4, i32 0)
  ...
  %11 = call fastcc i32 @julia_j_init_game_state_1688u1706(i32 5, i32 1)
  ret i32 %11
}

declare i32 @printf(i8* noalias nocapture, ...) local_unnamed_addr

define internal fastcc void @julia_j_init_game_state_1688u1691() unnamed_addr {
entry:
...
define internal fastcc void @julia_j_init_game_state_1688u1694(i32 %0, i32 %1) unnamed_addr {
entry:
...
define internal fastcc i32 @julia_j_init_game_state_1688u1706(i32 %0, i32 %1) unnamed_addr {
entry:
  %result = call i32 @set_game_state_simple(i32 %0, i32 %1)
  ret i32 %result
}
