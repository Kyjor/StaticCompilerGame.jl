...
define internal fastcc void @_throw_inexacterror_905() unnamed_addr #0 {
top:
...
define internal fastcc i32 @julia_checked_trunc_sint_902(i64 signext %0) unnamed_addr {
top:
...
L6:                                               ; preds = %top
  call fastcc void @_throw_inexacterror_905() #4
  br label %L7
...
define internal fastcc i32 @julia_toInt32_899(i64 signext %0) unnamed_addr {
top:
  %1 = call fastcc i32 @julia_checked_trunc_sint_902(i64 signext %0) #4
  ret i32 %1
}
...
top:
  ...
  %12 = call fastcc i32 @julia_toInt32_899(i64 signext %value_phi2) #4
  ret i32 %12
}
