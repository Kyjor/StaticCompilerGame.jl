...
function write_c_header(path::String)
    open(path, "w") do io
        ...
        println(io, "#define SC_KEY_ESCAPE 27")
        println(io, "#define SC_KEY_RETURN 13")
        println(io, "#define SC_KEY_BACKSPACE 8")
        println(io, "#define SC_KEY_TAB 9")
        println(io, "#define SC_KEY_SPACE 32")
        println(io, "#define SC_KEY_DELETE 127")
        println(io, "#define SC_KEY_LSHIFT 1073742049")
        println(io, "#define SC_KEY_RSHIFT 1073742053")
        println(io, "#define SC_KEY_LCTRL 1073742048")
        println(io, "#define SC_KEY_RCTRL 1073742052")
        println(io, "#define SC_KEY_LALT 1073742050")
        println(io, "#define SC_KEY_RALT 1073742054")
        println(io, "#define SC_KEY_UP 1073741906")
        println(io, "#define SC_KEY_DOWN 1073741905")
        println(io, "#define SC_KEY_LEFT 1073741904")
        println(io, "#define SC_KEY_RIGHT 1073741903")
        println(io, "")
        println(io, "/* Implement in host.c (optional): */")
        println(io, "void game_key_pressed(int32_t key);")
        println(io, "void game_key_released(int32_t key);")
        println(io, "")
        println(io, "#ifdef __cplusplus")
        println(io, "}")
        println(io, "#endif")
