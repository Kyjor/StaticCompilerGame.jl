...
top:
  ...
  call fastcc void @julia_j_init_game_state_1613u1616()
  call fastcc void @julia_j_init_game_state_1613u1617(i32 1, float 5.000000e+00)
  call fastcc void @julia_j_init_game_state_1613u1617(i32 2, float 5.000000e+00)
  call fastcc void @julia_j_init_game_state_1613u1617(i32 3, float 0.000000e+00)
  call fastcc void @julia_j_init_game_state_1613u1617(i32 4, float 0.000000e+00)
  call fastcc void @julia_j_init_game_state_1613u1621(i32 5, i32 1)
  call fastcc void @julia_j_init_game_state_1613u1617(i32 6, float 0.000000e+00)
  call fastcc void @julia_j_init_game_state_1613u1617(i32 7, float 0.000000e+00)
  %1 = call fastcc i32 @julia_j_init_game_state_1613u1624(i32 8, i32 0)
  ret i32 %1
}

declare i32 @printf(i8* noalias nocapture, ...) local_unnamed_addr

define internal fastcc void @julia_j_init_game_state_1613u1616() unnamed_addr {
entry:
...
define internal fastcc void @julia_j_init_game_state_1613u1617(i32 %0, float %1) unnamed_addr {
entry:
...
define internal fastcc void @julia_j_init_game_state_1613u1621(i32 %0, i32 %1) unnamed_addr {
entry:
...
define internal fastcc i32 @julia_j_init_game_state_1613u1624(i32 %0, i32 %1) unnamed_addr {
entry:
  %result = call i32 @set_game_state_simple(i32 %0, i32 %1)
  ret i32 %result
}
