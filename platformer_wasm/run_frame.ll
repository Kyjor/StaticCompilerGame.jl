...
define internal fastcc void @update_platformer_physics_1769() unnamed_addr {
top:
  ...
  %square_vel_y = load atomic {}*, {}** inttoptr (i64 139926547664896 to {}**) unordered, align 4096, !tbaa !2, !alias.scope !7, !noalias !10
  ...
  store {}* inttoptr (i64 139926574889584 to {}*), {}** %2, align 8
  %3 = call nonnull {}* @ijl_apply_generic({}* inttoptr (i64 139926350888080 to {}*), {}** nonnull %.sub, i32 2)
  store atomic {}* %3, {}** inttoptr (i64 139926547664896 to {}**) release, align 4096, !tbaa !2, !alias.scope !7, !noalias !10
  %key_left = load atomic {}*, {}** inttoptr (i64 139926547665376 to {}**) unordered, align 32, !tbaa !2, !alias.scope !7, !noalias !10
...
L6:                                               ; preds = %pass
  store atomic {}* inttoptr (i64 139926570017904 to {}*), {}** inttoptr (i64 139926547664656 to {}**) release, align 16, !tbaa !2, !alias.scope !7, !noalias !10
  br label %L16

L9:                                               ; preds = %pass
  %key_right = load atomic {}*, {}** inttoptr (i64 139926547665616 to {}**) unordered, align 16, !tbaa !2, !alias.scope !7, !noalias !10
...
L11:                                              ; preds = %pass28
  store atomic {}* inttoptr (i64 139926574889536 to {}*), {}** inttoptr (i64 139926547664656 to {}**) release, align 16, !tbaa !2, !alias.scope !7, !noalias !10
  br label %L16
...
L16:                                              ; preds = %L14, %L11, %L6
  %square_vel_x30 = phi {}* [ inttoptr (i64 139926410342048 to {}*), %L14 ], [ inttoptr (i64 139926574889536 to {}*), %L11 ], [ inttoptr (i64 139926570017904 to {}*), %L6 ]
...
L20:                                              ; preds = %pass8
  store atomic {}* inttoptr (i64 139926574889632 to {}*), {}** inttoptr (i64 139926547664896 to {}**) release, align 4096, !tbaa !2, !alias.scope !7, !noalias !10
  ...
  %square_vel_x.pre = load atomic {}*, {}** inttoptr (i64 139926547664656 to {}**) unordered, align 16, !tbaa !2, !alias.scope !7, !noalias !10
  br label %L23
...
L23:                                              ; preds = %pass8, %pass4, %L20
  ...
  %26 = call nonnull {}* @ijl_apply_generic({}* inttoptr (i64 139926350888080 to {}*), {}** nonnull %.sub, i32 2)
  store atomic {}* %26, {}** inttoptr (i64 139926547664176 to {}**) release, align 16, !tbaa !2, !alias.scope !7, !noalias !10
  %square_y = load atomic {}*, {}** inttoptr (i64 139926547664416 to {}**) unordered, align 32, !tbaa !2, !alias.scope !7, !noalias !10
  %square_vel_y9 = load atomic {}*, {}** inttoptr (i64 139926547664896 to {}**) unordered, align 4096, !tbaa !2, !alias.scope !7, !noalias !10
  ...
  %29 = call nonnull {}* @ijl_apply_generic({}* inttoptr (i64 139926350888080 to {}*), {}** nonnull %.sub, i32 2)
  store atomic {}* %29, {}** inttoptr (i64 139926547664416 to {}**) release, align 32, !tbaa !2, !alias.scope !7, !noalias !10
  %square_x10 = load atomic {}*, {}** inttoptr (i64 139926547664176 to {}**) unordered, align 16, !tbaa !2, !alias.scope !7, !noalias !10
  %30 = call {}** @julia.get_gc_frame_slot({}** nonnull %gcframe, i32 0)
  store {}* %square_x10, {}** %30, align 8
  store {}* %square_x10, {}** %.sub, align 8
  store {}* inttoptr (i64 139926410342048 to {}*), {}** %2, align 8
  %31 = call nonnull {}* @ijl_apply_generic({}* inttoptr (i64 139926354782848 to {}*), {}** nonnull %.sub, i32 2)
...
L34:                                              ; preds = %pass14
  store atomic {}* inttoptr (i64 139926410342048 to {}*), {}** inttoptr (i64 139926547664176 to {}**) release, align 16, !tbaa !2, !alias.scope !7, !noalias !10
  br label %L42

L37:                                              ; preds = %pass14
  %square_x20 = load atomic {}*, {}** inttoptr (i64 139926547664176 to {}**) unordered, align 16, !tbaa !2, !alias.scope !7, !noalias !10
  %37 = call {}** @julia.get_gc_frame_slot({}** nonnull %gcframe, i32 0)
  store {}* %square_x20, {}** %37, align 8
  store {}* %square_x20, {}** %.sub, align 8
  store {}* inttoptr (i64 139926570018016 to {}*), {}** %2, align 8
  %38 = call nonnull {}* @ijl_apply_generic({}* inttoptr (i64 139926356534544 to {}*), {}** nonnull %.sub, i32 2)
...
L40:                                              ; preds = %pass24
  store atomic {}* inttoptr (i64 139926570018016 to {}*), {}** inttoptr (i64 139926547664176 to {}**) release, align 16, !tbaa !2, !alias.scope !7, !noalias !10
  br label %L42

L42:                                              ; preds = %pass24, %L40, %L34
  %square_y15 = load atomic {}*, {}** inttoptr (i64 139926547664416 to {}**) unordered, align 32, !tbaa !2, !alias.scope !7, !noalias !10
  %44 = call {}** @julia.get_gc_frame_slot({}** nonnull %gcframe, i32 0)
  store {}* %square_y15, {}** %44, align 8
  store {}* %square_y15, {}** %.sub, align 8
  store {}* inttoptr (i64 139926570018048 to {}*), {}** %2, align 8
  %45 = call nonnull {}* @ijl_apply_generic({}* inttoptr (i64 139926349798256 to {}*), {}** nonnull %.sub, i32 2)
...
L45:                                              ; preds = %pass19
  store atomic {}* inttoptr (i64 139926570018048 to {}*), {}** inttoptr (i64 139926547664416 to {}**) release, align 32, !tbaa !2, !alias.scope !7, !noalias !10
  ...
  store atomic {}* inttoptr (i64 139926490197344 to {}*), {}** inttoptr (i64 139926547665136 to {}**) release, align 16, !tbaa !2, !alias.scope !7, !noalias !10
  br label %L49
...
fail:                                             ; preds = %top
  call void @ijl_type_error(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @_j_str1, i64 0, i64 0), {}* inttoptr (i64 139926422240480 to {}*), {}* %key_left)
  unreachable

pass:                                             ; preds = %top
  %51 = icmp eq {}* %key_left, inttoptr (i64 139926490197360 to {}*)
...
pass4:                                            ; preds = %L16
  %52 = icmp eq {}* %key_space, inttoptr (i64 139926490197360 to {}*)
...
pass8:                                            ; preds = %L18
  %53 = icmp eq {}* %on_ground, inttoptr (i64 139926490197360 to {}*)
  br i1 %53, label %L23, label %L20

fail13:                                           ; preds = %L23
  call void @ijl_type_error(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @_j_str1, i64 0, i64 0), {}* inttoptr (i64 139926422240480 to {}*), {}* %31)
  unreachable

pass14:                                           ; preds = %L23
  %54 = icmp eq {}* %31, inttoptr (i64 139926490197360 to {}*)
  br i1 %54, label %L37, label %L34

fail18:                                           ; preds = %L42
  call void @ijl_type_error(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @_j_str1, i64 0, i64 0), {}* inttoptr (i64 139926422240480 to {}*), {}* %45)
  unreachable

pass19:                                           ; preds = %L42
  %55 = icmp eq {}* %45, inttoptr (i64 139926490197360 to {}*)
  br i1 %55, label %L49, label %L45

fail23:                                           ; preds = %L37
  call void @ijl_type_error(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @_j_str1, i64 0, i64 0), {}* inttoptr (i64 139926422240480 to {}*), {}* %38)
  unreachable

pass24:                                           ; preds = %L37
  %56 = icmp eq {}* %38, inttoptr (i64 139926490197360 to {}*)
  br i1 %56, label %L42, label %L40

fail27:                                           ; preds = %L9
  call void @ijl_type_error(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @_j_str1, i64 0, i64 0), {}* inttoptr (i64 139926422240480 to {}*), {}* %key_right)
  unreachable

pass28:                                           ; preds = %L9
  %57 = icmp eq {}* %key_right, inttoptr (i64 139926490197360 to {}*)
...
define i32 @run_platformer_frame() local_unnamed_addr {
top:
  call fastcc void @update_platformer_physics_1769()
  %key_space = load atomic {}*, {}** inttoptr (i64 139926547665904 to {}**) unordered, align 16, !tbaa !2, !alias.scope !7, !noalias !10
...
L9:                                               ; preds = %pass4, %pass
  %value_phi = phi i32 [ 2, %pass ], [ %spec.select, %pass4 ]
  ret i32 %value_phi
